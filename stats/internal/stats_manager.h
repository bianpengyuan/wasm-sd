...
#ifndef STATS_INTERNAL_STATS_MANAGER_H_
#define STATS_INTERNAL_STATS_MANAGER_H_
 ...
 private:
  ...
  class MeasureInformation {
   public:
    ...
    // *mu_;
//    void MergeMeasureData(const stats::tags::TagMap& tags,
//                          const MeasureData& data, absl::Time now);
...
#endif  // STATS_INTERNAL_STATS_MANAGER_H_
