...
#ifndef PROTOBUF_INCLUDED_google_2fmonitoring_2fv3_2fcommon_2eproto
#define PROTOBUF_INCLUDED_google_2fmonitoring_2fv3_2fcommon_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fmonitoring_2fv3_2fcommon_2eproto 
...
const Aggregation_Aligner Aggregation_Aligner_Aligner_MAX = Aggregation_Aligner_ALIGN_COUNT_FALSE;
...
const Aggregation_Reducer Aggregation_Reducer_Reducer_MAX = Aggregation_Reducer_REDUCE_COUNT_FALSE;
...
enum ComparisonType {
  ...
  COMPARISON_EQ = 5,
  COMPARISON_NE = 6,
  ComparisonType_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ComparisonType_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool ComparisonType_IsValid(int value);
const ComparisonType ComparisonType_MIN = COMPARISON_UNSPECIFIED;
const ComparisonType ComparisonType_MAX = COMPARISON_NE;
const int ComparisonType_ARRAYSIZE = ComparisonType_MAX + 1;

const ::google::protobuf::EnumDescriptor* ComparisonType_descriptor();
inline const ::std::string& ComparisonType_Name(ComparisonType value) {
  return ::google::protobuf::internal::NameOfEnum(
    ComparisonType_descriptor(), value);
}
inline bool ComparisonType_Parse(
    const ::std::string& name, ComparisonType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ComparisonType>(
...
enum ServiceTier {
  ...
  ServiceTier_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  ServiceTier_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool ServiceTier_IsValid(int value);
const ServiceTier ServiceTier_MIN = SERVICE_TIER_UNSPECIFIED;
const ServiceTier ServiceTier_MAX = SERVICE_TIER_PREMIUM;
const int ServiceTier_ARRAYSIZE = ServiceTier_MAX + 1;

const ::google::protobuf::EnumDescriptor* ServiceTier_descriptor();
inline const ::std::string& ServiceTier_Name(ServiceTier value) {
  return ::google::protobuf::internal::NameOfEnum(
    ServiceTier_descriptor(), value);
}
inline bool ServiceTier_Parse(
    const ::std::string& name, ServiceTier* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ServiceTier>(
...
class Aggregation : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.monitoring.v3.Aggregation) */ {
 public:
  ...
  inline Aggregation* New() const final {
    return CreateMaybeMessage<Aggregation>(NULL);
  }

  Aggregation* New(::google::protobuf::Arena* arena) const final {
  ...
  static const Aligner ALIGN_COUNT_FALSE =
  ...
  static const Aligner ALIGN_PERCENT_CHANGE =
  ...
  static const Reducer REDUCE_COUNT_FALSE =
  ...
  private:
  const ::google::protobuf::Duration& _internal_alignment_period() const;
  public:
...
inline ::google::api::Distribution* TypedValue::mutable_distribution_value() {
  if (!has_distribution_value()) {
    ...
    value_.distribution_value_ = CreateMaybeMessage< ::google::api::Distribution >(
        GetArenaNoVirtual());
  }
...
inline const ::google::protobuf::Timestamp& TimeInterval::_internal_end_time() const {
  return *end_time_;
}
...
inline const ::google::protobuf::Timestamp& TimeInterval::_internal_start_time() const {
  return *start_time_;
}
...
inline const ::google::protobuf::Duration& Aggregation::_internal_alignment_period() const {
...
#endif  // PROTOBUF_INCLUDED_google_2fmonitoring_2fv3_2fcommon_2eproto
