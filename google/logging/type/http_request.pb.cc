...
::google::protobuf::internal::SCCInfo<1> scc_info_HttpRequest =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsHttpRequest}, {
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/logging/type/http_request.proto", schemas, file_default_instances, TableStruct::offsets,
...
const HttpRequest& HttpRequest::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2flogging_2ftype_2fhttp_5frequest_2eproto::scc_info_HttpRequest.base);
...
void HttpRequest::SerializeWithCachedSizes(
  ...
  if (this->has_latency()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      14, this->_internal_latency(), output);
  }
  ...
  if (this->has_latency()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        14, this->_internal_latency(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::logging::type::HttpRequest* Arena::CreateMaybeMessage< ::google::logging::type::HttpRequest >(Arena* arena) {
