...
#ifndef PROTOBUF_INCLUDED_google_2flogging_2fv2_2flogging_5fmetrics_2eproto
#define PROTOBUF_INCLUDED_google_2flogging_2fv2_2flogging_5fmetrics_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2flogging_2fv2_2flogging_5fmetrics_2eproto 
...
class LogMetric : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.LogMetric) */ {
 public:
  ...
  GOOGLE_PROTOBUF_DEPRECATED_ATTR static const int kVersionFieldNumber = 4;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR ::google::logging::v2::LogMetric_ApiVersion version() const;
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_version(::google::logging::v2::LogMetric_ApiVersion value);
...
class ListLogMetricsRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.ListLogMetricsRequest) */ {
 public:
  ...
  inline ListLogMetricsRequest* New() const final {
    return CreateMaybeMessage<ListLogMetricsRequest>(NULL);
  }

  ListLogMetricsRequest* New(::google::protobuf::Arena* arena) const final {
...
class ListLogMetricsResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.ListLogMetricsResponse) */ {
 public:
  ...
  inline ListLogMetricsResponse* New() const final {
    return CreateMaybeMessage<ListLogMetricsResponse>(NULL);
  }

  ListLogMetricsResponse* New(::google::protobuf::Arena* arena) const final {
...
class GetLogMetricRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.GetLogMetricRequest) */ {
 public:
  ...
  inline GetLogMetricRequest* New() const final {
    return CreateMaybeMessage<GetLogMetricRequest>(NULL);
  }

  GetLogMetricRequest* New(::google::protobuf::Arena* arena) const final {
...
class CreateLogMetricRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.CreateLogMetricRequest) */ {
 public:
  ...
  inline CreateLogMetricRequest* New() const final {
    return CreateMaybeMessage<CreateLogMetricRequest>(NULL);
  }

  CreateLogMetricRequest* New(::google::protobuf::Arena* arena) const final {
...
class UpdateLogMetricRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.UpdateLogMetricRequest) */ {
 public:
  ...
  inline UpdateLogMetricRequest* New() const final {
    return CreateMaybeMessage<UpdateLogMetricRequest>(NULL);
  }

  UpdateLogMetricRequest* New(::google::protobuf::Arena* arena) const final {
...
class DeleteLogMetricRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.DeleteLogMetricRequest) */ {
 public:
  ...
  inline DeleteLogMetricRequest* New() const final {
    return CreateMaybeMessage<DeleteLogMetricRequest>(NULL);
  }

  DeleteLogMetricRequest* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2flogging_2fv2_2flogging_5fmetrics_2eproto
