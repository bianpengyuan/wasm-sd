(module
  ...
  (global $20  (mut i32) (i32.const 3168))
  (global $21  (mut i32) (i32.const 5246048))
  ...
  (func $_internal_memalign (type $9)
    (param $0 i32)
    (param $1 i32)
    (result i32)
    (local $2 i32)
